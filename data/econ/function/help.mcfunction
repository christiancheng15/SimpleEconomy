...
tellraw @s ["",{"text":"/trigger leaderboard","bold":false,"color":"gold","clickEvent":{"action":"suggest_command","value":"/trigger leaderboard"},"hoverEvent":{"action":"show_text","contents":{"text":"Show top 10 balances (desc)"}}},{"color":"gray","text":" - view top 10 balances (desc)"}]
