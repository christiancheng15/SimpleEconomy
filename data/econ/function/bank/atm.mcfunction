...
tellraw @s {"text":"----------------------------","color":"dark_gray"}
tellraw @s ["",{"text":"[Balance]","color":"aqua","click_event":{"action":"run_command","command":"/trigger balance"},"hover_event":{"action":"show_text","value":{"text":"Show current balance"}}},{"text":"  "},{"text":"[Help]","color":"yellow","click_event":{"action":"run_command","command":"/trigger help"},"hover_event":{"action":"show_text","value":{"text":"Show all economy commands"}}}]
tellraw @s {"text":"============================","color":"dark_gray"}
